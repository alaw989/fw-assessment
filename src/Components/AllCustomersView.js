								...
								<div className="">
									<div className="two">
										<div className="px-3 pt-3">
											...
											<p className="quote2">Customer number: {data.customer_number}</p>
										</div>
										<div className="d-flex justify-content-start px-3 align-items-center">
										...
										<div className="d-flex justify-content-between px-3 align-items-center pb-3">
											<div className="d-flex justify-content-start align-items-center">
												<span className="quote2 ">Age: {getAge(data.date_birth)}</span>{' '}
											</div>
										</div>
										...
										<div className={`popover`}>
											...
											<div className="popover-address">
												...
												<br />
												{data.primary_address.city}, {data.primary_address.state}{' '}
